#!/usr/bin/env python3
"""
Скрипт для создания топиков numbers-input и numbers-output в Kafka.
"""
...
def create_topics():
    ...
    topics = [
        {'name': 'numbers-input', 'partitions': 1, 'replication': 1},
        {'name': 'numbers-output', 'partitions': 1, 'replication': 1}
    ]
